using MaemoCompliance.Admin.Api.Common;
using MaemoCompliance.Application.Evidence.Queries;
using MediatR;
...
public static class AdminEvidenceEndpoints
{
    public static IEndpointRouteBuilder MapAdminEvidenceEndpoints(this IEndpointRouteBuilder endpoints)
    {
        ...
        .WithOpenApi()
        .Produces<IReadOnlyList<MaemoCompliance.Application.Evidence.Dtos.EvidenceItemDto>>(StatusCodes.Status200OK)
