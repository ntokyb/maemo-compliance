using MaemoCompliance.Application.AuditLog.Queries;
...
public static class AuditLogEndpoints
{
    public static void MapAuditLogEndpoints(this WebApplication app)
    {
        ...
        .WithOpenApi()
        .Produces<IReadOnlyList<MaemoCompliance.Application.AuditLog.Dtos.AuditLogEntryDto>>(StatusCodes.Status200OK)
