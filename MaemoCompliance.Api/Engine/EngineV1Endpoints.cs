using MaemoCompliance.Api.Engine.Audits;
using MaemoCompliance.Api.Engine.Consultants;
using MaemoCompliance.Api.Engine.Documents;
using MaemoCompliance.Api.Engine.Ncrs;
using MaemoCompliance.Api.Engine.Risks;
using MaemoCompliance.Api.Engine.Tenants;
using MaemoCompliance.Api.Engine.Webhooks;

namespace MaemoCompliance.Api.Engine;
