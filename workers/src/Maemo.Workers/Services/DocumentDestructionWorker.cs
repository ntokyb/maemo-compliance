...
public class DocumentDestructionWorker : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            try
            {
                ...
                var fileStorageProvider = scope.ServiceProvider.GetRequiredService<Maemo.Application.Common.IFileStorageProvider>();
    ...
    private async Task ProcessDestroyedDocumentsAsync(
        MaemoDbContext dbContext,
        Guid tenantId,
        DateTime gracePeriodDate,
        Maemo.Application.Common.IFileStorageProvider fileStorageProvider,
