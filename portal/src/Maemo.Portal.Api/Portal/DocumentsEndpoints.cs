...
using DownloadDocumentFileQuery = Maemo.Application.Documents.Queries.DownloadDocumentFileQuery;
using DeleteDocumentCommand = Maemo.Application.Documents.Commands.DeleteDocumentCommand;
using GetDocumentVersionsQuery = Maemo.Application.Documents.Queries.GetDocumentVersionsQuery;
using CreateDocumentVersionCommand = Maemo.Application.Documents.Commands.CreateDocumentVersionCommand;
using DownloadDocumentVersionFileQuery = Maemo.Application.Documents.Queries.DownloadDocumentVersionFileQuery;
using DocumentVersionDto = Maemo.Application.Documents.Dtos.DocumentVersionDto;
using GetDocumentsPastRetentionQuery = Maemo.Application.Documents.Queries.GetDocumentsPastRetentionQuery;
using ArchiveDocumentCommand = Maemo.Application.Documents.Commands.ArchiveDocumentCommand;
using GetDocumentAuditEvidenceQuery = Maemo.Application.Documents.Queries.GetDocumentAuditEvidenceQuery;
using AuditEvidenceDto = Maemo.Application.Documents.Dtos.AuditEvidenceDto;
