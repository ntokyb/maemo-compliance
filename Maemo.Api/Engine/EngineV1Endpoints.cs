using Maemo.Api.Engine.Audits;
using Maemo.Api.Engine.Consultants;
using Maemo.Api.Engine.Documents;
using Maemo.Api.Engine.Ncrs;
using Maemo.Api.Engine.Risks;
using Maemo.Api.Engine.Tenants;
using Maemo.Api.Engine.Webhooks;

namespace Maemo.Api.Engine;
