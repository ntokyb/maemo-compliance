...
using ChangeDocumentStatusRequest = Maemo.Shared.Contracts.Engine.Documents.ChangeDocumentStatusRequest;
...
namespace Maemo.Api.Engine.Documents;
...
public static class DocumentsEngineEndpoints
{
    ...
    public static RouteGroupBuilder MapDocumentsEngineEndpoints(this RouteGroupBuilder engineGroup)
    {
            ...
            CancellationToken cancellationToken) =>
        {
            ...
            // Read comment from form collection to avoid Swashbuckle conflict with multiple [FromForm] parameters
