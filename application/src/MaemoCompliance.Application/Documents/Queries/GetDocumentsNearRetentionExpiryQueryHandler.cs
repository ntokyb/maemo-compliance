...
public class GetDocumentsNearRetentionExpiryQueryHandler : IRequestHandler<GetDocumentsNearRetentionExpiryQuery, IReadOnlyList<DocumentDto>>
{
    private readonly IApplicationDbContext _context;
    private readonly ITenantProvider _tenantProvider;
    private readonly IDateTimeProvider _dateTimeProvider;

    public GetDocumentsNearRetentionExpiryQueryHandler(
    ...
    public async Task<IReadOnlyList<DocumentDto>> Handle(GetDocumentsNearRetentionExpiryQuery request, CancellationToken cancellationToken)
    {
        var tenantId = _tenantProvider.GetCurrentTenantId();
        var cutoffDate = _dateTimeProvider.UtcNow.AddDays(request.DaysAhead);
        ...
        var documents = await _context.Documents
            .Where(d => 
                ...
                d.PiiRetentionPeriodInMonths.HasValue &&
                d.RetainUntil.HasValue &&
                d.RetainUntil.Value <= cutoffDate &&
